...
const hltvLocalLibraryPage = document.getElementById('hltv-local-library-page');
const playbookPage = document.getElementById('playbook-page');
...
const demoLibrarySummaryElement = document.getElementById('demo-library-summary');
...
const btnHltvSearch = document.getElementById('btn-hltv-search');
const btnHltvResetFilters = document.getElementById('btn-hltv-reset-filters');
const hltvStatusElement = document.getElementById('hltv-status');
const hltvCacheStatusElement = document.getElementById('hltv-cache-status');
const hltvDiscoverySummaryElement = document.getElementById('hltv-discovery-summary');
const hltvFilterSearchInput = document.getElementById('hltv-filter-search');
const hltvFilterDemoOnlyInput = document.getElementById('hltv-filter-demo-only');
const hltvBrowseSummaryElement = document.getElementById('hltv-browse-summary');
const hltvMatchListElement = document.getElementById('hltv-match-list');
const btnLocalLibraryRefresh = document.getElementById('btn-local-library-refresh');
const btnLocalLibraryClearAll = document.getElementById('btn-local-library-clear-all');
const btnLocalLibraryOpenHltv = document.getElementById('btn-local-library-open-hltv');
const localLibrarySummaryElement = document.getElementById('local-library-summary');
const localLibraryStatusElement = document.getElementById('local-library-status');
const localLibraryTabListElement = document.getElementById('local-library-tab-list');
const localLibraryMatchSearchInput = document.getElementById('local-library-match-search');
const localLibraryMapSearchInput = document.getElementById('local-library-map-search');
const localLibraryFilterDemoOnlyInput = document.getElementById('local-library-filter-demo-only');
const localLibraryFilterDownloadedOnlyInput = document.getElementById('local-library-filter-downloaded-only');
const localLibraryFilterParsedOnlyInput = document.getElementById('local-library-filter-parsed-only');
const localLibraryMatchListElement = document.getElementById('local-library-match-list');
const localLibraryTeamSearchInput = document.getElementById('local-library-team-search');
const localLibraryTeamListElement = document.getElementById('local-library-team-list');
const localLibraryPlayerSearchInput = document.getElementById('local-library-player-search');
const localLibraryPlayerListElement = document.getElementById('local-library-player-list');
const localLibraryPanelMatchesElement = document.getElementById('local-library-panel-matches');
const localLibraryPanelTeamsElement = document.getElementById('local-library-panel-teams');
const localLibraryPanelPlayersElement = document.getElementById('local-library-panel-players');
const playbookSummaryElement = document.getElementById('playbook-summary');
const playbookStatusElement = document.getElementById('playbook-status');
const playbookTabListElement = document.getElementById('playbook-tab-list');
const playbookMapGridElement = document.getElementById('playbook-map-grid');
const playbookGrenadeListElement = document.getElementById('playbook-grenade-list');
const playbookTacticListElement = document.getElementById('playbook-tactic-list');
const playbookSetupListElement = document.getElementById('playbook-setup-list');
const playbookPanelMapsElement = document.getElementById('playbook-panel-maps');
const playbookPanelGrenadesElement = document.getElementById('playbook-panel-grenades');
const playbookPanelTacticsElement = document.getElementById('playbook-panel-tactics');
const playbookPanelSetupsElement = document.getElementById('playbook-panel-setups');
const playbookRoundGrenadeCandidatesElement = document.getElementById('playbook-round-grenade-candidates');
const btnPlaybookImportGrenades = document.getElementById('btn-playbook-import-grenades');
const playbookRoundGrenadeStatusElement = document.getElementById('playbook-round-grenade-status');
...
let playbookRoundGrenadeCandidates = [];
let playbookRoundGrenadeSelection = new Set();
let demoLibraryData = [];
