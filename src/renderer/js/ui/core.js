...
const btnHltvCardSave = document.getElementById('btn-hltv-card-save');
const btnHltvCardDelete = document.getElementById('btn-hltv-card-delete');
const btnHltvCardClear = document.getElementById('btn-hltv-card-clear');
...
const hltvFilterCloseOnlyInput = document.getElementById('hltv-filter-close-only');
const hltvFilterFeaturedOnlyInput = document.getElementById('hltv-filter-featured-only');
const hltvRecommendedSummaryElement = document.getElementById('hltv-recommended-summary');
const hltvRecommendedListElement = document.getElementById('hltv-recommended-list');
...
const hltvQueueSummaryElement = document.getElementById('hltv-queue-summary');
const hltvQueueListElement = document.getElementById('hltv-queue-list');
const hltvCardSummaryElement = document.getElementById('hltv-card-summary');
const hltvCardListElement = document.getElementById('hltv-card-list');
const hltvCardMatchLabelElement = document.getElementById('hltv-card-match-label');
const hltvCardTitleInput = document.getElementById('hltv-card-title');
const hltvCardNoteInput = document.getElementById('hltv-card-note');
...
const localLibraryFilterQueuedOnlyInput = document.getElementById('local-library-filter-queued-only');
const localLibraryFilterCardsOnlyInput = document.getElementById('local-library-filter-cards-only');
